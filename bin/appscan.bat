...
@rem If APPSCAN_INSTALL_DIR is not defined, warn that register.bat must be run for .NET targets
if defined APPSCAN_INSTALL_DIR goto checkJavaHome
echo.
echo WARNING: You must run the following script as administrator prior to scanning any .NET targets:
echo %tab%%~dp0\register.bat
echo.
